...
import ru.rent.factory.ManufacturerMockFactory
import java.util.*
...
class ManufacturerRepositoryTest {
    ...
    fun `save entity`() {
        ...
        assertEquals(firstManufacturer.unit.size, findManufacturer.unit.size)
    }
    ...
    fun `find by id`() {
        ...
        assertEquals(foungManufacurer?.unit?.size, firstManufacturer.unit.size)
    }
