...
import ru.rent.factory.ModelMockFactory
import java.util.*
...
class ModelRepositoryTest {
    ...
    fun `save entity`() {
        ...
        assertEquals(firstModel.unit.size, foundModel.unit.size)
    }
    ...
    fun `find all`() {
        ...
        for ((index, model) in models.withIndex()) {
            ...
            assertEquals(model.unit.size, actualModels[index].unit.size)
        }
    }
